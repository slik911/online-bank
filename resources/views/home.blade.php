            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-7">
                            <p>Users</p>
                            <h4 style="line-height: 5px;">{{number_format($user)}}</h4>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-7">
                                <p>Debit</p>
                                <h4 style="line-height: 5px;">${{number_format($debit)}}</h4>
                            </div>
                            <div class="col-3 pt-1">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-7">
                            <p>Credit</p>
                            <h4 style="line-height: 5px;">${{number_format($credit)}}</h4>
                        </div>
                        <div class="col-3 pt-1">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-7">
                            <p>Transactions</p>
                            <h4 style="line-height: 5px;">${{number_format($total_transaction)}}</h4>
                        </div>
                        <div class="col-3 pt-1">
