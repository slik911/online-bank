            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('create.users')}}" key="t-login">Create Users</a></li>
                        <li><a href="{{route('users')}}" key="t-login-2">Manage Users</a></li>
                ...
                <li>
                    <a href="{{route('accounts')}}" class="waves-effect">
                        ...
                        <span key="t-horizontal">Accounts</span>
                    </a>
                </li>


                <li>
                    <a href="{{route('account.settings')}}" class="waves-effect">
                        <i class="bx bx-cog"></i>
                        <span key="t-horizontal">Settings</span>
                    </a>
                </li>
    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{route('transfer.funds')}}" class="waves-effect">
                        <i class="bx bx-trending-up"></i>
                        <span key="t-horizontal">Transfer</span>
                    </a>
                </li>

                <li>
                    <a href="{{route('loans')}}" class="waves-effect">
                        <i class="bx bx-bar-chart-square"></i>
                        <span key="t-horizontal">Loan</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{route('card')}}" class="waves-effect">
                        ...
                        <span key="t-horizontal">Cheques & Cards</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('support')}}" class="waves-effect">
                        <i class="bx bx-windows"></i>
                        <span key="t-horizontal">Contact Support</span>
                    </a>
                </li>
{{--
                <li class="menu-title" key="t-pages">Pages</li>
